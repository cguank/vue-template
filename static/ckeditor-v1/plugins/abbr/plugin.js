CKEDITOR.plugins.add('abbr', {
  ...
  init: function (editor) {
    // editor.addCommand('abbr123', new CKEDITOR.dialogCommand('abbrDialog'));
    editor.addCommand('abbr123', new CKEDITOR.dialogCommand('my-mathjax'));
    // editor.addCommand('abbr123', {
    ...
    CKEDITOR.dialog.add('my-mathjax', this.path + 'dialogs/mathjax.js');
  }
});
//  (function () {
//    CKEDITOR.plugins.add("abbr", {
...
//      init: function (b) {
//        let editor = b;
//       //  editor.addCommand('myMathJaxDialog', new CKEDITOR.dialogCommand('mathjaxDialog'))
//            if (editor.contextMenu) {
//              editor.addMenuGroup('abbrGroup');
//              editor.addMenuItem('abbrItem', {
//                label: '一键转latex',
...
//          a.data.dataValue = a.data.dataValue.replace(/<\/head>/,
...
//    CKEDITOR.plugins.mathjax.fixSrc = CKEDITOR.env.gecko ? "javascript:true" : CKEDITOR.env.ie ? "javascript:void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.close();") +
//      "})())" : "javascript:void(0)";
...
//    };
//    CKEDITOR.plugins.mathjax.frameWrapper = CKEDITOR.env.ie &&
//      8 == CKEDITOR.env.version ? function (b, c) {
...
//            CKEDITOR.plugins.mathjax.copyStyles(b,
//              d);
//            c.fire("lockSnapshot");
//            b.setStyles({
